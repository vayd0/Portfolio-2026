            ...
            {project.projectUrl && (
              <div style={{ position: "relative" }}>
                ...
                <div ref={annotationRef} style={{ position: "absolute", right: -80, top: "calc(100% + 6px)", display: "flex", alignItems: "flex-start", gap: 6, transform: "rotate(-5deg)", pointerEvents: "none", userSelect: "none" }}>
                  ...
                  <span style={{ fontFamily: "Dudu, sans-serif", fontSize: "clamp(1rem, 1.3vw, 1.3rem)", color: "#555", marginTop: 10, marginLeft: -18, display: "inline-block", transform: "rotate(18deg)", WebkitTextStroke: "0.5px #333" }}>c&apos;est par ici !</span>
                </div>
              </div>
            )}
            {project.github && (
