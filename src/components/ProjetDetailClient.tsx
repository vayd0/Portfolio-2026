            ...
            {project.projectUrl && (
              <div style={{ position: "relative" }}>
                ...
                <div ref={annotationRef} style={{ position: "absolute", right: -40, top: "calc(100% + 6px)", display: "flex", alignItems: "flex-start", gap: 6, transform: "rotate(-5deg)", pointerEvents: "none", userSelect: "none" }}>
                  ...
                  <span style={{ fontFamily: "Dudu, sans-serif", fontSize: "clamp(0.8rem, 1vw, 1rem)", color: "#555", marginTop: 10, display: "inline-block", transform: "rotate(-8deg)" }}>c&apos;est par ici !</span>
                </div>
              </div>
            )}
            {project.github && (
