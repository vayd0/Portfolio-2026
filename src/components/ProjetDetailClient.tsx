  ...
  return (
    <div ref={containerRef} className="relative md:h-full md:overflow-hidden" style={{ background: "#fff" }}>
      ...
      {project.description && (
        ...
        >
          <div style={{ position: "absolute", width: 0, height: 0, bottom: "100%", left: 0, borderTop: "18px solid #111", borderRight: "18px solid #111", borderLeft: "18px solid transparent", borderBottom: "18px solid transparent", pointerEvents: "none", transform: "rotate(90deg)" }} />
          <div style={{ position: "absolute", width: 0, height: 0, left: "100%", bottom: 0, borderTop: "18px solid #111", borderRight: "18px solid #111", borderLeft: "18px solid transparent", borderBottom: "18px solid transparent", pointerEvents: "none", transform: "rotate(90deg)" }} />
